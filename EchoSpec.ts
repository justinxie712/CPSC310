...
describe("EchoSpec", function () {
    ...
    it("PUT description with one course", function () {
        let insight = new InsightFacade();
        let file = "/Users/jxie/cpsc310_team168/test/Test Data/oneValidCourse.zip"
        let fs = require("fs");
    ...
    it("PUT description with all rooms", function () {
        let insight = new InsightFacade();
        let file = "/Users/jxie/cpsc310_team168/test/Test Data/rooms.zip"
        let fs = require("fs");
        return chai.request("http://localhost:4321")
            .put('/dataset/rooms')
            .attach("body", fs.readFileSync(file), file)
