...
import insightFacade, {default as InsightFacade} from "../controller/InsightFacade";
        ...
        return new Promise(function (fulfill, reject) {
            try {
                ...
                that.rest.put("/dataset/:id", function (req: restify.Request, res: restify.Response, next: restify.Next) {
                    ...
                    insight.addDataset(id, content).then(function (code: any) {
                        let resCode = code.code;
                        let body = code.body;
                ...
                that.rest.del("/dataset/:id", function (req: restify.Request, res: restify.Response, next: restify.Next){
                    ...
                    let insight = new InsightFacade();
                    insight.removeDataset(id).then(function (code: any) {
                        let resCode = code.code;
                        let body = code.body;
                        res.send(resCode, body);
                    }).catch(function (code) {
                ...
                that.rest.post("/query", function (req: restify.Request, res: restify.Response, next: restify.Next){
                    ...
                    let insight = new InsightFacade();
                    insight.performQuery(req.body).then(function (code: any) {
                        let resCode = code.code;
                        let body = code.body;
                        res.send(resCode, body);
                    }).catch(function (code) {
