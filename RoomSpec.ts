...
describe("RoomSpec", function () {
    ...
    it("Should 204 or 201, with valid rooms, WORKS", function () {
        let insight = new InsightFacade();
        let fs = require("fs");
        let file = fs.readFileSync("test/Test Data/rooms.zip", "base64");

        return insight.addDataset("rooms", file).then(function (response: InsightResponse) {
            console.log("Code: " + response.code);
    ...
    it("Remove existing file on course", function () {
        let insight = new InsightFacade();
        let fs = require("fs");
        let file = fs.readFileSync("/Users/jxie/cpsc310_team168/test/Test Data/two_valid_courses.zip", "base64");
    ...
    it("Remove existing file on room", function () {
        let insight = new InsightFacade();
        let fs = require("fs");
        let file = fs.readFileSync("/Users/jxie/cpsc310_team168/test/Test Data/rooms.zip", "base64");
